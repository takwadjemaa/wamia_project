...
class Website(models.Model):
    ...
    mp_seller_new_status_msg = fields.Text(
        string="For New Status",
        default="Thank you for registering with us, to enjoy the benefits of our marketplace fill all your details and request for approval.",
        translate=True)
    mp_seller_pending_status_msg = fields.Text(
        string="For Pending Status",
        default="Thank you for seller request, your request has been already sent for approval we'll process your request as soon as possible.",
        translate=True)
